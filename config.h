...
static const char col_gray1[]       = "#222222"; // unactive windwo
static const char col_gray2[]       = "#444444"; // letter color
static const char col_gray3[]       = "#bbbbbb"; // idk
static const char col_gray4[]       = "#1b1b1d"; // tags color
static const char col_cyan[]        = "#fabd2f"; //accent color
